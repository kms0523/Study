...
stress-strain 관계식이 단순한 성형이 아닌 경우를 material nonlinearity라고 한다.
...
# Force Nonliearity
force가 주어진 boundary condition이 변형에 대한 함수로 주어진 경우를 kinematic nonliearity라고 한다.
...
<p align = "center">
<img src = "./image/2022.09.08_5.png">
</p>

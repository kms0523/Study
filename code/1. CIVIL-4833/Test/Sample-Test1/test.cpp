...
TEST(quadratic_formula, Test13)
{ 
	const double x1 = 0, x2 = 5, x3 = 5, x4 = 1;
	const double y1 = 5, y2 = 5, y3 = -1, y4 = 0;
	const double xp = 5;
	const double yp = 4.76;

	double xi = 0, eta = 0;
	quadratic_formula(xi, eta, xp, yp, x1, x2, x3, x4, y1, y2, y3, y4);
	EXPECT_NEAR(xi, 1.0, epsilon);
	EXPECT_NEAR(eta, -0.92, epsilon);
}
TEST(quadratic_formula, Test14)
{
	const double x1 = 1, x2 = 2, x3 = 2, x4 = 1;
	const double y1 = 1, y2 = 2, y3 = 5, y4 = 2;
	const double xp = 1;
	const double yp = 1;
